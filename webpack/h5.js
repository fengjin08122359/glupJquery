...
H5APPEARANCE.prototype = {
  ...
  initLoad: function () {
    ...
    if(this.options.selectColor){
      this.insertStyle(".dialogue-me .dialogue-c{background: "+ this.options.selectColor +"}")
    }
...
var baseUrl = ucc.baseUrl
var audiojs = __webpack_require__(49)
      ...
      $('#dialogue-add').uploadFile({
        ...
        other: function (up, name, time) {
          ...
          dialogue.showMsg({
            ...
            from: 'visitor',
            content: '<img id="' + time + '" src="' + __webpack_require__(44) + '">'
          })
          var key = msgdb.last()
          up.submit(time, key)
        },
...
!(function (a) {
   true ? a(typeof module === 'object' && module.exports ? jQuery : jQuery) : a(typeof module === 'object' && module.exports ? jQuery : jQuery)
}(function (a) {
  function b (b) {
    var c = {},
      d = /^jQuery\d+$/
  ...
  var f, g, h = !1,
    i = Object.prototype.toString.call(window.operamini) === '[object OperaMini]',
  ...
  j && k ? (g = a.fn.placeholder = function () {
    ...
    return n = a.extend({}, e, b), this.filter((j ? 'textarea' : ':input') + '[' + (h ? 'placeholder-x' : 'placeholder') + ']').not('.' + n.customClass).not(':radio, :checkbox, [type=hidden]').bind({
      ...
      var b = !0
      try {
        document.activeElement.toString() === 'javascript:void(0)' && (b = !1)
      } catch (c) {}
...
WEBSOCKET.prototype = {
  ...
  reconnectionFun: function () {
    var w = this
    if (!w.isWork) return
    w.ReconnectingWebSocket = __webpack_require__(51)
  },
...
//  }();
  ...
  var loadinggif = __webpack_require__(45)
  var pausegif = __webpack_require__(46)
  var playpng = __webpack_require__(47)
  var playergif = __webpack_require__(48)
  g[h] = {
    instanceCount: 0,
    instances: {},
...
pageLoad = __webpack_require__(43)
params = __webpack_require__(3)
